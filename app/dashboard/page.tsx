                    ...
                    <TabsContent value="overview" className="mt-0">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        <Card className="md:col-span-1 border-[#6A9FB5]/20 hover:shadow-lg transition-all duration-300">
                          ...
                          <CardContent>
                            <WellnessScoreChart score={wellnessScores.overall} />
                                ...
                                .map(([key, value]) => (
                                  <motion.div
                                    ...
                                    transition={{
                                      duration: 0.5,
                                      delay:
                                        key === "sleep" ? 0.1 : key === "anxiety" ? 0.2 : key === "mood" ? 0.3 : 0.4,
                                    }}
                                  >
                                    ...
                                    <Progress
                                      ...
                                      style={
                                        {
                                          "--theme-primary": key === "anxiety" ? "#F5E1DA" : "#6A9FB5",
